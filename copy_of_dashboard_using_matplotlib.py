# -*- coding: utf-8 -*-
"""Copy of Dashboard using Matplotlib.ipynb
...
df = pd.read_csv('/content/drive/MyDrive/nic data check/Data/Registration/Registration_Data.csv')
...
def plot_data(selected_yaxis):
    ...
    plt.bar(df['maker'], df[selected_yaxis])
    ...
    fig_bar_plotly = px.bar(df, x='maker', y=selected_yaxis).update_xaxes(tickangle=330)
